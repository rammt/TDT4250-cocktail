 ...
 * @generated
 */
public class CocktailSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case CocktailPackage.COCKTAIL_PARTY: {
			CocktailParty cocktailParty = (CocktailParty) theEObject;
			T result = caseCocktailParty(cocktailParty);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CocktailPackage.DRINK_INGREDIENT: {
			DrinkIngredient drinkIngredient = (DrinkIngredient) theEObject;
			T result = caseDrinkIngredient(drinkIngredient);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseCocktailParty(CocktailParty object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Drink Ingredient</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Drink Ingredient</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDrinkIngredient(DrinkIngredient object) {
		return null;
	}
